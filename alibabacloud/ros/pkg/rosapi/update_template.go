...
// UpdateTemplate invokes the ros.UpdateTemplate API synchronously
// api document: https://help.aliyun.com/api/ros/updatetemplate.html
...
// UpdateTemplateWithChan invokes the ros.UpdateTemplate API asynchronously
// api document: https://help.aliyun.com/api/ros/updatetemplate.html
...
// UpdateTemplateWithCallback invokes the ros.UpdateTemplate API asynchronously
// api document: https://help.aliyun.com/api/ros/updatetemplate.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateUpdateTemplateRequest() (request *UpdateTemplateRequest) {
	...
	request.InitWithApiInfo("ROS", "2019-09-10", "UpdateTemplate", "ros", "openAPI")
	return
}
