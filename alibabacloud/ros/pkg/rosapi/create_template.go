...
// CreateTemplate invokes the ros.CreateTemplate API synchronously
// api document: https://help.aliyun.com/api/ros/createtemplate.html
...
// CreateTemplateWithChan invokes the ros.CreateTemplate API asynchronously
// api document: https://help.aliyun.com/api/ros/createtemplate.html
...
// CreateTemplateWithCallback invokes the ros.CreateTemplate API asynchronously
// api document: https://help.aliyun.com/api/ros/createtemplate.html
// asynchronous document: https://help.aliyun.com/document_detail/66220.html
...
func CreateCreateTemplateRequest() (request *CreateTemplateRequest) {
	...
	request.InitWithApiInfo("ROS", "2019-09-10", "CreateTemplate", "ros", "openAPI")
	return
}
